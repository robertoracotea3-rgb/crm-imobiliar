...
/**
 * @param {{ id: string, internal_code?: string | null, category?: string | null, city?: string | null, attributes?: Record<string, unknown> | null }} property
 */
export function buildPublicPropertyUrl(property) {
  const attrs = property.attributes || {};
  const attrText = key => (typeof attrs[key] === 'string' ? attrs[key] : '');
  const category =
