...
export const DEFAULT_PERMISSIONS: Record<string, PermissionMap> = {
  ...
  agent_senior: {
    ...
    tasks: ownCrud(), mail: ownCrud(), notifications: ownCrud(),
  ...
  agent: {
    ...
    mail: ownCrud(), notifications: ownCrud(), transactions: ownCrud({ view_financial: true }),
    reports: readOnly(),
  },
  assistant: {
  ...
  accountant: {
    ...
    reports: { ...readOnly(true), export: true, view_financial: true },
    mail: ownCrud(), notifications: ownCrud(),
  },
  viewer: {
    dashboard: readOnly(true),
